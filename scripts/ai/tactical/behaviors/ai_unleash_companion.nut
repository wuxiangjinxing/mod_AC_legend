this.ai_unleash_companion <- this.inherit("scripts/ai/tactical/behavior", {
	m = {
		PossibleSkills = [
	...
	function create()
	{
		this.m.ID = this.Const.AI.Behavior.ID.UnleashCompanion;			
		this.m.Order = this.Const.AI.Behavior.Order.UnleashCompanion;		
		this.m.Round = this.Math.rand(1, 4);
