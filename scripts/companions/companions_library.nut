...
gt.Const.Companions.Library <- [
	...
	{
		ID = "accessory.springbob",
		Type = this.Const.Companions.TypeList.SpringBob,
		Name = function() { return "Bob"; },
		NameUnleashed = "Vor Jotunn Collar",
		Description = "A Vor Jotunn, tamed to be a loyal companion in battle. Can be unleashed in battle for scouting, tracking or running down routing enemies.",
		DescriptionUnleashed = "The collar of a Vor Jotunn that has been unleashed onto the battlefield.",
		IconLeashed = function(variant) { return "tools/demonhound_01_ac.png"; },
		IconUnleashed = "tools/hound_01_leash_70x70.png",
		Value = 6000,
		PartyStrength = 46,
		Variant = function() { return 1; },
		BasicAttributes = { Hitpoints = 400, Stamina = 300, Bravery = 150, Initiative = 115, MeleeSkill = 70, RangedSkill = 65, MeleeDefense = 10, RangedDefense = 30 },
		PreferredAttribute = this.Const.Attributes.RangedSkill,
		Script = "scripts/companions/types/companions_springbob",
		ArmorScript = null,
		UnleashSounds = ["sounds/enemies/unhold_idle_01.wav",
		...
		InventorySounds = ["sounds/enemies/unhold_idle_07.wav"],
		Unleash = {	Script = "scripts/companions/onequip/companions_unleash",
					Icon = function(variant) { return "skills/demonhound_01_ac.png"; },
					IconDisabled = function(variant) { return "skills/demonhound_01_sw_ac.png"; },
					Overlay = "active_165",
	...
	{
		ID = "accessory.summerbob",
		Type = this.Const.Companions.TypeList.SummerBob,
		Name = function() { return "Bob"; },
		NameUnleashed = "Sumar Jotunn Collar",
		Description = "A Sumar Jotunn, tamed to be a loyal companion in battle. Can be unleashed in battle for scouting, tracking or running down routing enemies.",
		DescriptionUnleashed = "The collar of a Sumar Jotunn that has been unleashed onto the battlefield.",
		IconLeashed = function(variant) { return "tools/demonhound_01_ac.png"; },
		IconUnleashed = "tools/hound_01_leash_70x70.png",
		Value = 6000,
		PartyStrength = 46,
		Variant = function() { return 1; },
		BasicAttributes = { Hitpoints = 400, Stamina = 300, Bravery = 150, Initiative = 90, MeleeSkill = 75, RangedSkill = 0, MeleeDefense = 10, RangedDefense = 10 },
		PreferredAttribute = this.Const.Attributes.MeleeSkill,
		Script = "scripts/companions/types/companions_summerbob",
		ArmorScript = null,
		UnleashSounds = ["sounds/enemies/unhold_idle_01.wav",
			"sounds/enemies/unhold_idle_02.wav",
			"sounds/enemies/unhold_idle_03.wav",
	...
	{
		ID = "accessory.autumnbob",
		Type = this.Const.Companions.TypeList.AutumnBob,
		Name = function() { return "Bob"; },
		NameUnleashed = "Haust Jotunn Collar",
		Description = "A Haust Jotunn, tamed to be a loyal companion in battle. Can be unleashed in battle for scouting, tracking or running down routing enemies.",
		DescriptionUnleashed = "The collar of a Haust Jotunn that has been unleashed onto the battlefield.",
		IconLeashed = function(variant) { return "tools/demonhound_01_ac.png"; },
		IconUnleashed = "tools/hound_01_leash_70x70.png",
		Value = 6000,
		PartyStrength = 46,
		Variant = function() { return 1; },
		BasicAttributes = { Hitpoints = 400, Stamina = 300, Bravery = 150, Initiative = 100, MeleeSkill = 70, RangedSkill = 0, MeleeDefense = 15, RangedDefense = 10 },
		PreferredAttribute = this.Const.Attributes.MeleeSkill,
		Script = "scripts/companions/types/companions_autumnbob",
		ArmorScript = null,
		UnleashSounds = ["sounds/enemies/unhold_idle_01.wav",
			"sounds/enemies/unhold_idle_02.wav",
			"sounds/enemies/unhold_idle_03.wav",
	...
	{
		ID = "accessory.winterbob",
		Type = this.Const.Companions.TypeList.WinterBob,
		Name = function() { return "Bob"; },
		NameUnleashed = "Vetur Jotunn Collar",
		Description = "A Vetur Jotunn, tamed to be a loyal companion in battle. Can be unleashed in battle for scouting, tracking or running down routing enemies.",
		DescriptionUnleashed = "The collar of a Vetur Jotunn that has been unleashed onto the battlefield.",
		IconLeashed = function(variant) { return "tools/demonhound_01_ac.png"; },
		IconUnleashed = "tools/hound_01_leash_70x70.png",
		Value = 6000,
		PartyStrength = 46,
		Variant = function() { return 1; },
		BasicAttributes = { Hitpoints = 400, Stamina = 300, Bravery = 150, Initiative = 80, MeleeSkill = 70, RangedSkill = 0, MeleeDefense = 20, RangedDefense = 10 },
		PreferredAttribute = this.Const.Attributes.MeleeDefense,
		Script = "scripts/companions/types/companions_winterbob",
		ArmorScript = null,
		UnleashSounds = ["sounds/enemies/unhold_idle_01.wav",
			"sounds/enemies/unhold_idle_02.wav",
			"sounds/enemies/unhold_idle_03.wav",
