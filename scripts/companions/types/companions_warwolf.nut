this.companions_warwolf <- this.inherit("scripts/entity/tactical/actor", {
	...
	function onFactionChanged()
	{
		...
		this.getSprite("restrain").setHorizontalFlipping(flip);
	...
	function onInit()
	{
		...
		local restrain = this.addSprite("restrain");
		restrain.setBrush("bust_wolf_02_armor_01");
		restrain.Visible = false;
		...
		this.setSpriteOffset("restrain", offset);
