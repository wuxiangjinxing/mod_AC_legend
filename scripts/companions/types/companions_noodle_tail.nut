this.companions_noodle_tail <- this.inherit("scripts/entity/tactical/enemies/lindwurm_tail", {
	m = {
		Body = null,
		Racial = null,
		Item = null,
	...
	{
		this.lindwurm_tail.onFactionChanged();
	...
	{
		this.lindwurm_tail.onActorKilled(_actor, _tile, _skill);
