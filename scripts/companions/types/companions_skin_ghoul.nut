this.companions_skin_ghoul <- this.inherit("scripts/entity/tactical/enemies/legend_skin_ghoul", {
	m = {
		Item = null,
		Name = "Skin Ghoul",
		Size = 1,
	...
	function setVariant(_v)
	{
		...
		{
			this.getSprite("body").setBrush("bust_ghoulskin_body_0" + this.m.Size);
			this.getSprite("head").setBrush("bust_ghoulskin_0" + this.m.Size + "_head_0" + this.m.Head);
			this.getSprite("injury").setBrush("bust_ghoulskin_0" + this.m.Size + "_injured");
	...
	{
		this.legend_skin_ghoul.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.legend_skin_ghoul.onFactionChanged();
	...
	{
		this.legend_skin_ghoul.onActorKilled(_actor, _tile, _skill);
