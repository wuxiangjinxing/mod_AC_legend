this.companions_winterbob <- this.inherit("scripts/entity/tactical/enemies/bob_winter.nut", {
	m = {
		Item = null,
		Name = "Vor Jotunn"
	},
	...
	{
		this.bob_winter.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.bob_winter.onFactionChanged();
	...
	{
		this.bob_winter.onActorKilled(_actor, _tile, _skill);
