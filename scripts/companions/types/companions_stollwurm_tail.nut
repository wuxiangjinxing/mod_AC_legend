this.companions_stollwurm_tail <- this.inherit("scripts/entity/tactical/enemies/legend_stollwurm_tail", {
	m = {
		Body = null,
		Racial = null,
		Item = null,
	...
	function create()
	{
		this.legend_stollwurm_tail.create();
	...
	{
		this.legend_stollwurm_tail.onFactionChanged();
	...
	{
		this.legend_stollwurm_tail.onActorKilled(_actor, _tile, _skill);
	...
	function onInit()
	{
		this.legend_stollwurm_tail.onInit();
