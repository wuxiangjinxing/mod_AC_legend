this.companions_summerbob <- this.inherit("scripts/entity/tactical/enemies/bob_summer.nut", {
	m = {
		Item = null,
		Name = "Sumar Jotunn"
	},
	...
	{
		this.bob_summer.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.bob_summer.onFactionChanged();
	...
	{
		this.bob_summer.onActorKilled(_actor, _tile, _skill);
