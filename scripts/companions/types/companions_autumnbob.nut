this.companions_autumnbob <- this.inherit("scripts/entity/tactical/enemies/bob_autumn.nut", {
	m = {
		Item = null,
		Name = "Haust Jotunn"
	},
	...
	{
		this.bob_autumn.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.bob_autumn.onFactionChanged();
	...
	{
		this.bob_autumn.onActorKilled(_actor, _tile, _skill);
