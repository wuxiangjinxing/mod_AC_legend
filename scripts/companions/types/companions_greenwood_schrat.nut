this.companions_greenwood_schrat <- this.inherit("scripts/entity/tactical/enemies/legend_greenwood_schrat", {
	m = {
		Item = null,
		Name = "Greenwood Schrat"
	},
	function create()
	{
		this.legend_greenwood_schrat.create();
	...
	{
		this.getSprite("body").setBrush("bust_schrat_green_body_01");
		this.getSprite("head").setBrush("bust_schrat_green_head_0" + _v);
		this.setDirty(true);
	}

	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		this.legend_greenwood_schrat.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.legend_greenwood_schrat.onFactionChanged();
	...
	{
		this.legend_greenwood_schrat.onActorKilled(_actor, _tile, _skill);
	...
	function onInit()
	{
		this.legend_greenwood_schrat.onInit();
		this.legend_greenwood_schrat.assignRandomEquipment();
