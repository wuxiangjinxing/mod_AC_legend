this.companions_white_direwolf <- this.inherit("scripts/entity/tactical/enemies/legend_white_direwolf", {
	m = {
		Item = null,
		Name = "White Direwolf"
	},
	...
	{
		this.getSprite("body").setBrush("bust_direwolf_white_01_body");
		this.getSprite("head").setBrush("bust_direwolf_white_01_head");
		this.setDirty(true);
	}

	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		this.legend_white_direwolf.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.legend_white_direwolf.onFactionChanged();
	...
	{
		this.legend_white_direwolf.onActorKilled(_actor, _tile, _skill);
	...
	function onInit()
	{
		this.legend_white_direwolf.onInit();
