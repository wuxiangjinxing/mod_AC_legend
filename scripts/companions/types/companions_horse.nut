this.companions_horse <- this.inherit("scripts/entity/tactical/enemies/legend_horse", {
	m = {
		Item = null,
		Name = "Horse",
		IsHigh = false
	...
	{
		this.legend_horse.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.legend_horse.onFactionChanged();
		local flip = this.isAlliedWithPlayer();
		this.getSprite("horse").setHorizontalFlipping(flip);
		this.getSprite("horse_head").setHorizontalFlipping(flip);
	...
	{
		this.legend_horse.onActorKilled(_actor, _tile, _skill);
