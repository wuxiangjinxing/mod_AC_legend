this.companions_springbob <- this.inherit("scripts/entity/tactical/enemies/bob_spring.nut", {
	m = {
		Item = null,
		Name = "Vor Jotunn"
	},
	...
	{
		this.bob_spring.onDeath(_killer, _skill, _tile, _fatalityType);
	...
	{
		this.bob_spring.onFactionChanged();
	...
	{
		this.bob_spring.onActorKilled(_actor, _tile, _skill);
